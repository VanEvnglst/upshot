...
const ScheduleDiscussion = props => { 
  ...
  const handleScheduleDiscussion = () => { 
    ...
    dispatch(CaptureMomentActions.setFeedbackMomentData('f2fSchedule', scheduleDetails))
      ...
      <View style={{margin: 24, borderTopWidth: 1, borderTopColor: '#B1B5C3'}}>
        ...
        <View style={{ marginTop: 24 }}>
          ...
          <View style={{ minWidth: 327, height: 48, flexDirection: 'row', justifyContent: 'space-between', borderWidth: 2, borderColor: '#353945', borderRadius: 12, alignItems: 'center', marginTop: 12}}>
              <Text style={{ color: '#FCFCFD', fontWeight: '500', fontSize: 14, lineHeight: 24, marginLeft: 18 }}>{selectedDate}</Text>
        ...
        <View style={{ marginTop: 24, minWidth: 327, flexDirection: 'row', justifyContent: 'flex-start' }}>
          ...
          <Text style={{ color: '#B1B5C3', fontWeight: '700', fontSize: 12, lineHeight: 12, textTransform: 'uppercase', width: 157.5 }}>Start time</Text>
            ...
            <View style={{ height: 48, flexDirection: 'row', justifyContent: 'space-between', borderWidth: 2, borderColor: '#353945', borderRadius: 12, alignItems: 'center', marginTop: 12 }}>
                <Text style={{ color: '#FCFCFD', fontWeight: '500', fontSize: 14, lineHeight: 24, marginLeft: 18 }}>{startTime}</Text>
            <Icon name="chevron-down-circle-outline" size={24} color='#777E90' style={{marginRight: 10}} />
              </View>
              </TouchableOpacity>
          </View>
          ...
          <View style={{ height: 48, flexDirection: 'row', justifyContent: 'space-between', borderWidth: 2, borderColor: '#353945', borderRadius: 12, alignItems: 'center', marginTop: 12}}>
              <Text style={{ color: '#FCFCFD', fontWeight: '500', fontSize: 14, lineHeight: 24, marginLeft: 18 }}>{ endTime }</Text>
            <Icon name="chevron-down-circle-outline" size={24} color='#777E90' style={{marginRight: 10}} />
              </View>
              </TouchableOpacity>
          </View>
          ...
          <DateTimePicker
            ...
            onConfirm={(confirmTime) => handleTimeConfirm(confirmTime, timePickerID)}
            date={dateNow}
            />
        ...
        <View style={{marginTop: 24}}>
          ...
          <View style={{ minWidth: 327, height: 48, justifyContent: 'center', borderWidth: 2, borderColor: '#353945', borderRadius: 12, marginTop: 12, textAlignVertical: 'center'}}>
            <TextInput style={{ color: '#FCFCFD', fontWeight: '500', fontSize: 14, lineHeight: 24, marginLeft: 18, textAlign: 'left', alignItems: 'center', height: 32}}
