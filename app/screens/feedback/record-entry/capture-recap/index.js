  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', borderBottomWidth: 1, borderBottomColor: "#B1B5C3", paddingBottom: 20}}>
        ...
        <View>
              <Text style={{fontSize: 24, lineHeight: 30, fontWeight: '700', color: '#667080', paddingTop: 20}}>Feedback Summary</Text>
              <Text style={styles.selectedName}>Review the details before proceeding</Text>
            </View>
            </View>
        ...
        <View style={{marginBottom: 12, flexDirection: 'row'}}>
          ...
          <Text style={[styles.topicLabel, { marginBottom: 4, marginTop: 12 }]}>Feedback Type</Text>
        ...
        <View style={styles.topicPicker}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: '70%'}}>
              <TouchableOpacity style={{ minWidth: '95%', backgroundColor: '#667080', height: 48, borderRadius: 6, justifyContent: 'center', alignItems: 'center' }}
                onPress={() => navigation.navigate('Record Feedback Entry')}>
                <Text style={{fontSize: 16, lineHeight: 22, fontWeight: '700', color: '#FFFFFF'}}>Continue</Text>
              </TouchableOpacity>
            </View>
          </View>
          </View>
