...
const StopDoingResponse = props => {
  ...
  const [stopDoingClarification, setStopDoingClarification] = useState('');
  ...
  useEffect(() => {
    Animated.timing(translation, {
      toValue: showAnswerContainer ? keyboardStatus === 'didShow' ? -400 : -600 : 0,
      duration: 250,
  ...
  const handleTextChange = () => {
    setStopDoingClarification(storedText);
  };
  ...
  const handleNext = () => {
    dispatch(FrontlinerFeedbackActions.setResponseData('stopDoing', stopDoingClarification))
    dispatch(FrontlinerFeedbackActions.setResponseActiveStep(activeStep + 1));
  };
    ...
    <View style={styles.container}>
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={{ marginTop: 30, minHeight: 300 }}>
              ...
              <Text style={styles.entryText}>
                {frontlinerFeedback.employee_stop_doing === '' ? "None provided." : frontlinerFeedback.employee_stop_doing}
              </Text>
            </View>
          ...
          <TextInput
           ...
           {showAnswerContainer && (
              <TouchableOpacity
                ...
                <Icon name={'arrow-forward-outline'} size={24} color={'#353945'} />
              </TouchableOpacity>
            )}
          {!showAnswerContainer && (
            <TouchableOpacity
      ...
      {showAnswerContainer && (
        <View
          ...
          >
            <Text style={{ fontSize: 14, lineHeight: 24, color:"white", fontWeight: '400'}}>{stopDoingClarification}</Text>
          </View>
)}
        </View>
      )}
...
export default StopDoingResponse;

StopDoingResponse.propTypes = {};

StopDoingResponse.defaultPropst = {};
