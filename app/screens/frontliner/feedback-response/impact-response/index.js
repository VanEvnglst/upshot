      ...
      <GradientBackground
        ...
        <View style={styles.contentContainer}>
          <View
            ...
            <Text style={styles.questionText}>The impact of this observation/behavior to the business or the team...</Text>
          </View>
...
export default ImpactResponse;

ImpactResponse.propTypes = {};

ImpactResponse.defaultPropst = {};
