...
const OverviewStep13 = () => {
  ...
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[12]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step13', data));
    setTimeout(() => {
