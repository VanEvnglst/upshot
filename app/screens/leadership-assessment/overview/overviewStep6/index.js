...
const OverviewStep6 = () => {
  ...
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[5]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step6', data));
    setTimeout(() => {
