...
const OverviewStep14 = () => {
  const dispatch = useDispatch();
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[13]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step14', data));
    setTimeout(() => {
