...
const OverviewStep10 = () => {
  const dispatch = useDispatch();
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[9]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step10', data));
    setTimeout(() => {
