...
const OverviewStep2 = () => {
  ...
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[1]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step2', data));
    setTimeout(() => {
