...
const OverviewStep9 = () => {
  ...
  const questionTitle = useSelector(state => state.leadershipSkillArea.get('overviewQuestions')[8]);
  ...
  const handleSelection = option => {
    ...
    dispatch(leadershipSkillAreaActions.setAssessmentData('step9', data));
    setTimeout(() => {
