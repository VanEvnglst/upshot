        ...
        {checkCategoryStatus[element.categoryState] - 3 === 7 ? (
          ...
          >
            <View style={[styles.stepCounter, { borderColor: element.color }]}>
              <Text style={[styles.stepText, { color: element.color }]}>
                {checkCategoryStatus[element.categoryState]}/10
              </Text>
            </View>
          ...
          <TouchableOpacity
            ...
            <View style={[styles.stepCounter, { borderColor: '#BAC0CA' }]}>
              <Text style={[styles.stepText, { color: '#667080' }]}>
                {' '}
                {checkCategoryStatus[element.categoryState] === null
                  ? 0
            ...
            <View style={styles.skillTitleContainer}>
              ...
              <Text style={styles.completionText}>
                {(checkCategoryStatus[element.categoryState] / 10) * 100}%
                completed
              </Text>
            </View>
      ...
      <ScrollView>
        <View style={styles.headerContainer}>
          ...
          <View style={styles.headerTextContainer}>
            <Text style={styles.headerText}>Leadership Skill Area</Text>
          </View>
        ...
        <View style={styles.titleContainer}>
          <View style={styles.titleUser}>
            ...
            <Text style={styles.descriptionText}>
              Your Upshot journey awaits. With a little jump start, you will see
              where your strength lies by answering these areas.
            </Text>
        ...
        <View style={styles.contentContainer}>
          {lsaTypes.map(element => {
            return <SkillAreaItem key={element.id} element={element} />;
          })}
          {/* {completedCnt === 5 ?
          <TouchableOpacity
