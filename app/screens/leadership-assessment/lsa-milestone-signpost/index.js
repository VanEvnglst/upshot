  ...
  const checkInContent = [
    {
      ...
      description: "Better leadership begins with self-awareness. Leverage on the skills that you're good at, and build on the skills that have room for improvement.",
      bgColor: '#FFF0C3',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Becoming a better leader takes practice, but where do we start? We'll know what to focus on by seeing how you answer the questions.",
      bgColor: '#F0E0FF',
    },
    {
      id: 4,
      ...
      description: "We're starting to get a better idea what kid of leader you are. Finish strong and let's see what you get!",
      bgColor: '#FFE8E3',
    },
    {
      id: 5,
      ...
      description: "You should be proud of yourself. You're making progress by completing all of the Leadership Skill Area tests.\n\nNow, are you ready to see your profile?",
      bgColor: '#FFE8C8',
    }
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.contentContainer}>
        <View style={[styles.imageContainer, { backgroundColor: content.bgColor}]}>
        <Image
        ...
        <Text style={[styles.completionText, styles.addedMargin]}>{content.id === 5 ? 'Congratulations!' : 'You completed the test'}</Text>
      ...
      <View style={styles.btnContainer}>
        <Button
          ...
          style={styles.button}  
        >
          <Text style={styles.buttonText}>{content.id === 5 ? 'Calculate my score': 'Continue'}</Text>
          </Button>
          <Button
            mode='text'
            onPress={() => {}}
            style={{ marginTop: 24 }}
          ><Text style={[styles.completionText, { textTransform:'none'}]}>{content.id === 5 ? 'Cancel' : 'Retake Test'}</Text></Button>
      </View>
